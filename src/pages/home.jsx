    ...
    <Paper className={classes.paper}>
      <Grid container>
        ...
        <Typography variant="body1" align="left">
          ...
          <br />A integração e análise deste complexo conjunto de informações
          irá gerar uma lista de fármacos (individuais ou combinados),
          candidatos ao reposicionamento, adequados aos diversos casos clínicos.
          Este projeto ocorrerá em cinco fases. Na Fase I, analisaremos os dados
          de transcriptoma e proteoma associados ao COVID-19 e comorbidades
          relacionadas, processando dados disponíveis na literatura e em bancos
          de dados públicos, usando o algoritmo MetaCell. A Fase II consiste na
          construção de redes de PPI associadas a genes e caracterizaçáo das
          vias que são afetadas pelo COVID-19 em diferentes tecidos. Na Fase
          III, utilizaremos redes neurais recorrentes (e.g., Hopfield
          paramétrico) para a reconstrução da paisagem epigenética relacionada
          ao COVID-19, com base em listas de genes. A Fase IV é a proposta de um
          algoritmo de identificação de alvos com base nos resultados das Fases
          I, II e III. A Fase V é a identificação de medicamentos aprovados ou
          experimentais associados aos alvos identificados, classificados em
          termos de toxicidade e expressão gênica.
        </Typography>
      </Grid>
    </Paper>
  );
